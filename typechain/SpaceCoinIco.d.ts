...
interface SpaceCoinIcoInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addressesContributed",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "amountContributedByAddress",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "movePhaseForward",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "owner", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "purchaseSpaceCoin",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class SpaceCoinIco extends BaseContract {
  ...
  functions: {
    ...
    addressesContributed(
      arg0: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[string]>;

    amountContributedByAddress(
      arg0: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
